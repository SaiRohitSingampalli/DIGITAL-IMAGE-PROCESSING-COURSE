%% CREATING DIRCTORIES, GIVING PATHS, COMPRESSION(JPEG90,70,50) AND FEATURE EXTRACTION
clc;
clear all;
% GENERATING DIRECTORIES TO STORE ORIGINAL/JPEG90/70/50 AND MF3+ORIGINAL,JPEG90/70/50
...
%% FEATURE EXTRACTION FOR ORIGINAL IMAGE BY TRUNCATING DIFFERENCE B\W MED 
% FINALLY APPLIED MARKOV RANDOM CHAIN
...
%% FEATURE EXTRACTION FOR [ORIGINAL IMAGE+MF3]
     ...
     for i = -3:1:3
        for j= -3:1:3
          for k=-3:1:3
              ...
              p1(i+4,j+4,k+4) = y/(x+1);
              p2(i+4,j+4,k+4) = yy/(xx+1);
              p3(i+4,j+4,k+4) = yyy/xxx;
              p4(i+4,j+4,k+4) = yyyy/xxxx;
          end
        end
...
%% FEATURE EXTRACTION FOR [JPEG90+MF3]
...
%% FEATURE EXTRACTION FOR [JPEG70+MF3]
...
%% FEATURE EXTRACTION FOR [JPEG50+MF3]
