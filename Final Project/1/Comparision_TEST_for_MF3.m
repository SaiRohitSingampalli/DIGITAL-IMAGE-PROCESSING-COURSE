clc;
clear all;
%% COMPARISON BETWEEN 1.ORIRINAL AND MEDIAN FILTERED IMAGE(MF3)
%                     2.JPEG90 AND JPEG90+MEDIAN FILTERED IMAGE(MF3)
%                     3.JPEG70 AND JPEG70+MEDIAN FILTERED IMAGE(MF3)
%                     4.JPEG50 AND JPEG50+ MEDIAN FILTERED IMAGE(MF3)
