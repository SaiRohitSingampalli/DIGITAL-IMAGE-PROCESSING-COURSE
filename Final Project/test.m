...
load(a_residual_mat1);
load(a_residual_mat2);
load(a_residual_mat3);
load(a_residual_mat4);
load(a_residual_mat5);
load(a_residual_mat6);
load(a_residual_mat7);
load(a_residual_mat8);

[res_size_1_m,res_size_1_n]=size(new_avg1);
[res_size_2_m,res_size_2_n]=size(new_avg2);
[res_size_3_m,res_size_3_n]=size(new_avg3);
[res_size_4_m,res_size_4_n]=size(new_avg4);
[res_size_5_m,res_size_5_n]=size(new_avg5);
[res_size_6_m,res_size_6_n]=size(new_avg6);
[res_size_7_m,res_size_7_n]=size(new_avg7);
[res_size_8_m,res_size_8_n]=size(new_avg8);

label_1 = zeros(res_size_1_m+1,res_size_1_n+1);
label_2 = zeros(res_size_2_m+1,res_size_2_n+1);
label_3 = zeros(res_size_3_m+1,res_size_3_n+1);
label_4 = zeros(res_size_4_m+1,res_size_4_n+1);
label_5 = ones(res_size_5_m+1,res_size_5_n+1);
label_6 = ones(res_size_6_m+1,res_size_6_n+1);
label_7 = ones(res_size_7_m+1,res_size_7_n+1);
label_8 = ones(res_size_8_m+1,res_size_8_n+1);

% for i=1:1:res_size_1_m
%     for j=1:1:res_size_1_n
%         label_1(i,j)=new_avg1(i,j);
%     end
% end
% 
% for i=1:1:res_size_2_m
%     for j=1:1:res_size_2_n
%         label_2(i,j)=new_avg2(i,j);
%     end
% end
% 
% for i=1:1:res_size_3_m
%     for j=1:1:res_size_3_n
%         label_3(i,j)=new_avg3(i,j);
%     end
% end
% 
% for i=1:1:res_size_4_m
%     for j=1:1:res_size_4_n
%         label_4(i,j)=new_avg4(i,j);
%     end
% end
% 
% for i=1:1:res_size_5_m
%     for j=1:1:res_size_5_n
%         label_5(i,j)=new_avg5(i,j);
%     end
% end
% 
% for i=1:1:res_size_6_m
%     for j=1:1:res_size_6_n
%         label_6(i,j)=new_avg6(i,j);
%     end
% end
% 
% for i=1:1:res_size_7_m
%     for j=1:1:res_size_7_n
%         label_7(i,j)=new_avg7(i,j);
%     end
% end
% 
% for i=1:1:res_size_8_m
%     for j=1:1:res_size_8_n
%         label_8(i,j)=new_avg8(i,j);
%     end
% end
